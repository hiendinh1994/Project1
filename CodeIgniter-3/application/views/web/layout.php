	  ...
	  <!--header-->
		...
		<div class="header-bottom">			
				<div class="logo">
					...
					<div class="ad-right">
					<img class="img-responsive" src="<?php echo base_url()?>assets/web/images/ad.png" alt=" " >
				</div>
				<div class="clearfix"> </div>
			</div>	
	...
	<div class="content">
		...
		<div class="women-in">
				...
				<div class="in-line">
					...
					<div class="lady-in">
						<div class="col-md-4 you-para">
							<a href="single.html"><img class="img-responsive pic-in" src="<?php echo base_url()?>assets/web/images/pi.jpg" alt=" " ></a>
							<div class="you-in">
						...
						<div class="col-md-4 you-para">
							<a href="single.html"><img class="img-responsive pic-in" src="<?php echo base_url()?>assets/web/images/pi4.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
						...
						<div class="col-md-4 you-para para-grid">
							<a href="single.html"><img class="img-responsive pic-in" src="<?php echo base_url()?>assets/web/images/pi5.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
						...
						<div class="col-md-4 you-para">
							<a href="single.html"><img class="img-responsive pic-in" src="<?php echo base_url()?>assets/web/images/pi6.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
			...
			<div class="col-md-3 col-m-left">
				...
				<div class="discount">
					<a href="single.html"><img class="img-responsive pic-in" src="<?php echo base_url()?>assets/web/images/p2.jpg" alt=" " >	</a>		
						<p class="no-more">Exclusive <b>discount</b> <span>Womens wear</span></p>					
					<a href="#" class="know-more">know more</a>
				</div>
				<div class="discount">
					<a href="single.html"><img class="img-responsive pic-in" src="<?php echo base_url()?>assets/web/images/p3.jpg" alt=" " ></a>			
			...
			<div class="buy-an">
					...
					<ul id="flexiselDemo1">			
				<li><a href="#"><img class="img-responsive women" src="<?php echo base_url()?>assets/web/images/pic.jpg" alt=""></a>
				<div class="hide-in">
				<p>Premium Denim Women's Hidden</p>
				<span>$179.00  |  <a href="#">Buy Now </a></span>
				</div></li>
				<li><a href="#"><img class="img-responsive women" src="<?php echo base_url()?>assets/web/images/pic1.jpg" alt=""></a>
				<div class="hide-in">
				<p>Premium Denim Women's Hidden</p>
				<span>$179.00  |  <a href="#">Buy Now </a></span>
				</div></li>
				...
				<li><a href="#"><img class="img-responsive women" src="<?php echo base_url()?>assets/web/images/pic2.jpg" alt=""></a>
				<div class="hide-in">
				<p>Premium Denim Women's Hidden</p>
				<span>$179.00  |  <a href="#">Buy Now </a></span>
				</div></a></li>
	...
	<div class="footer">
		<div class="container">
				...
				<div class="footer-left">
					<a href="index.html"><img src="<?php echo base_url()?>assets/web/images/logo1.png" alt=" " ></a>
				</div> 
				<div class="clearfix"> </div>
			 	</div>
		 </div>
